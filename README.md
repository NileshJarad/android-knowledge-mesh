...
5. [ViewModel](android/src/main/kotlin/android/viewmodel.md)
6. [LiveData , SharedFlow and StateFlow](android/src/main/kotlin/android/live_data_state_shared_flow.md)
7. [Serialize vs Parcelable](android/src/main/kotlin/android/serialize_parcelable.md)
8. Storage
    - Shared Preference
    - [EncryptedSharedPreferences](android/src/main/kotlin/security/encrypted_shared_preferences.md)
    - Database
    - File
9. [Threading](android/src/main/kotlin/threading/thread_lopper_handler.md)
...
10. [Networking](android/src/main/kotlin/networking/networking.md)
     ...
     - [Multi-part requests](android/src/main/kotlin/networking/networking.md#multi-part-requests)
...
11. [Dependency Injection / Service locator](android/src/main/kotlin/di_service_locator/di_and_service_locator.md)
12. Security
    ...
    - Tap jacking
13. Android Jetpack
14. [Compose](android/src/main/kotlin/compose/compose.md)
...
15. Kotlin
    ...
    - [Class](android/src/main/kotlin/kotlin_fundamentals/classes.md)
        ...
        -
16. [Coroutine](android/src/main/kotlin/coroutine/coroutine.md)
17. Testing
    - Unit test
        - Turbine
        - STRIKT
